        ...
        <div className='min-h-[100vh] w-[100vw] flex justify-center items-center relative bg-[#222831]'>
            ...
            {register && <div className='flex mx-4 shadow-lg justify-center rounded-xl items-center max-w-[500px] flex-col my-10 overflow-hidden'>
                <div className="relative w-full h-[170px]">
                    ...
                    <div className="absolute inset-0 bg-black/60 flex justify-center items-center"><img className="h-15 w-44 sm:h-20 sm:w-60" src="/logo.png" alt="logo" /></div>
                </div>
                <div className='w-full bg-[#283035] flex justify-center flex-col'>
                    ...
                    <form onSubmit={submitlogin}>
                        <input onChange={(e) => {setUsername(e.target.value)}} className='mx-4 bg-[#222831] rounded-md placeholder-[#424f58] text-[#424f58] outline-none w-[87%] sm:w-[450px] pl-4 h-[40px]' placeholder='Username'/>
                        <div className="flex bg-[#222831] items-center m-4 mt-5 rounded-md w-[87%] sm:w-[450px] pl-4 h-[40px] justify-between pr-4"><input type={visible ? "text" : "password"} onChange={(e) => {setPassword(e.target.value)}} className='w-[87%] sm:w-[400px] outline-none placeholder-[#424f58] bg-[#222831] text-[#424f58]' placeholder='Password'/><div className="cursor-pointer" onClick={() => {setVisible(!visible)}}><img className="h-6" src="/eye.svg" alt="change_visiblity" /></div></div>
                        <button type="submit" className="w-[87%] h-[40px] mx-4 mt-5 rounded-md text-[#283035] font-bold bg-[#00ADB5] hover:opacity-70 duration-700 sm:w-[450px]">Sign In</button>
                    </form>
            ...
            {!register && 
            <div className='flex mx-4 shadow-lg justify-center rounded-xl items-center max-w-[500px] flex-col my-10 overflow-hidden'>
                ...
                <div className='w-full bg-[#283035] flex justify-center flex-col'>
                    ...
                    <form onSubmit={submitregister}>
                        ...
                        <div className="flex bg-[#222831] items-center m-4 mt-5 rounded-md w-[87%] sm:w-[450px] pl-4 h-[40px] justify-between pr-4"><input type={confirmvisible ? "text" : "password"} onChange={(e) => {setConfirmPassword(e.target.value)}} className='w-[250px] sm:w-[400px] outline-none placeholder-[#424f58] bg-[#222831] text-[#424f58]' placeholder='Confirm Password'/><div className="cursor-pointer" onClick={() => {setConfirmVisible(!confirmvisible)}}><img className="h-6" src="/eye.svg" alt="change_visiblity" /></div></div>
                        <button type="submit" className="w-[87%] h-[40px] mx-4 mt-5 rounded-md text-[#283035] font-bold bg-[#00ADB5] hover:opacity-70 duration-700 sm:w-[450px]">Register Now</button>
                    </form>
