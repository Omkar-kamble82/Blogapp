        ...
        <div className='min-h-[100vh] w-[100vw] flex justify-center items-center bg-[#222831]'>
            {register && <div className='flex mx-4 shadow-lg justify-center rounded-xl items-center max-w-[500px] flex-col min-h-[70vh] my-10 overflow-hidden'>
                ...
                <div className='w-full bg-[#283035] flex justify-center flex-col'>
                    ...
                    <button className="w-[300px] pl-4 h-[40px] mx-4 mt-5 rounded-md text-[#283035] font-bold bg-[#00ADB5] hover:opacity-70 duration-700 sm:w-[450px]">Sign In</button>
            ...
            {!register && <div className='flex mx-4 shadow-lg justify-center rounded-xl items-center max-w-[500px] flex-col min-h-[70vh] my-10 overflow-hidden'>
                ...
                <div className='w-full bg-[#283035] flex justify-center flex-col'>
                    ...
                    <button className="w-[300px] pl-4 h-[40px] mx-4 mt-5 rounded-md text-[#283035] font-bold bg-[#00ADB5] hover:opacity-70 duration-700 sm:w-[450px]">Register Now</button>
